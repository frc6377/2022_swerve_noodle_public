...
public class PodConstants {
  ...
  private PodConstants(int    DRIVE_MOTOR,
                       int    STEER_MOTOR,
                       int    STEER_ENCODER,
                       double STEER_OFFSET) {
  ...
  public final static class PodConstantsBuilder {
    ...
    public PodConstants build(){
      boolean error = false;
      if(encoderID     == null) {System.out.println("Encoder created without encoderID"); error = true;}
      if(encoderOffset == null) {System.out.println("Pod created without encoderOffset"); error = true;}
      if(location == null) {System.out.println("Pod created without location"); error = true;}
